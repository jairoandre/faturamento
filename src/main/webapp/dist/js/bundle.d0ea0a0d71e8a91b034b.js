...
/***/ function(module, exports, __webpack_require__) {
	...
	var _user$project$Model_SemRemessa$SemRemessaItem = F5(
		function (a, b, c, d, e) {
			return {convenio: a, status: b, quantidade: c, mediaDias: d, mediaValor: e};
		});
	var _user$project$Model_SemRemessa$semRemessaItemDecoder = A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'mediaValor',
		_elm_lang$core$Json_Decode$string,
		'R$ 0,00',
			...
			A4(
				...
				A4(
					...
					A4(
						...
						_elm_lang$core$Json_Decode$string,
						'',
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model_SemRemessa$SemRemessaItem))))));
	var _user$project$Model_SemRemessa$semRemessaDecoder = A2(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$hardcoded,
		0,
		A2(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$hardcoded,
	...
	var _user$project$Model_Faturamento$FaturamentoItem = F9(
		function (a, b, c, d, e, f, g, h, i) {
			return {convenio: a, pendentes: b, daysAvg: c, ge30: d, lt30: e, ge30Avg: f, lt30Avg: g, ge30ValueAvg: h, lt30ValueAvg: i};
		});
	var _user$project$Model_Faturamento$faturamentoItemDecoder = A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'lt30ValueAvg',
		_elm_lang$core$Json_Decode$string,
		'',
							...
							A4(
								...
								A4(
									...
									A4(
										...
										_elm_lang$core$Json_Decode$string,
										'',
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model_Faturamento$FaturamentoItem))))))))));
	var _user$project$Model_Faturamento$faturamentoGrupoDecoder = A2(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$hardcoded,
		0,
		A2(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$hardcoded,
			...
			A2(
				...
				A4(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
					'items',
					_elm_lang$core$Json_Decode$list(_user$project$Model_Faturamento$faturamentoItemDecoder),
					_elm_lang$core$Native_List.fromArray(
						[]),
					A4(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
						...
						_elm_lang$core$Json_Decode$string,
						'',
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model_Faturamento$FaturamentoGrupo))))));
	...
	var _user$project$Api$getFaturamento = F2(
		function (error, success) {
			return A3(
				_elm_lang$core$Task$perform,
				error,
	...
	var _user$project$View_Utils$customDiv = F3(
		function (wrapperClass, innerClass, elem) {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class(wrapperClass)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class(innerClass)
							]),
						_elm_lang$core$Native_List.fromArray(
							[elem]))
					]));
		});
	var _user$project$View_Utils$divLeftPadding = F2(
		function (wrapperClass, elem) {
			return A3(_user$project$View_Utils$customDiv, wrapperClass, 'lPadd', elem);
		});
	var _user$project$View_Utils$divRightPadding = F2(
		function (wrapperClass, elem) {
			return A3(_user$project$View_Utils$customDiv, wrapperClass, 'rPadd', elem);
		});

	var _user$project$View_TempoMedio$tempoMedioItemToHtml = F2(
		function (idx, item) {
			var media = A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('cell cell--media')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('row--inner--padding--right')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(item.media))
							]))
					]));
			var quantidade = A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('cell cell--quantidade')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(item.quantidade))
							]))
					]));
			var convenio = A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('cell cell--convenio')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('row--inner--padding')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
			...
			var rowClass = _elm_lang$core$Native_Utils.eq(
				A2(_elm_lang$core$Basics_ops['%'], idx, 2),
				0) ? A2(_elm_lang$core$Basics_ops['++'], 'row--wrapper row--wrapper--zebra ', topClass) : A2(_elm_lang$core$Basics_ops['++'], 'row--wrapper ', topClass);
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
	...
	var _user$project$View_TempoMedio$tempoMedioToHtml = function (tempoMedio) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('list--wrapper list--wrapper--tempoMedio')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('header--wrapper')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('header--wrapper--top')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('header--title header--title--tempoMedio')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('header--wrapper--bottom')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A3(
									_user$project$View_Utils$customDiv,
									'header--column header--column--convenio',
									'header--inner',
	...
	var _user$project$View_SemRemessa$semRemessaItemToHtml = F2(
		function (idx, item) {
			var mediaValor = A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('cell cell--mediaValor')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(item.mediaValor)
							]))
					]));
			var mediaDias = A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(item.mediaDias))
							]))
					]));
			var qtdSpan = A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$Basics_ops['++'], 'span--padding span--padding--', item.status))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[convenio, quantidade, mediaDias, mediaValor]));
		});
	var _user$project$View_SemRemessa$semRemessaToHtml = function (semRemessa) {
		var items = A2(_elm_lang$core$List$drop, semRemessa.page * 20, semRemessa.items);
		var rows = A2(
			_elm_lang$core$List$indexedMap,
			_user$project$View_SemRemessa$semRemessaItemToHtml,
			A2(_elm_lang$core$List$take, 20, items));
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('list--wrapper list--wrapper--semRemessa')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('header--title header--title--semRemessa')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									A3(
									_user$project$View_Utils$customDiv,
									'header--column header--column--mediaValor',
									'header--inner--right',
									_elm_lang$html$Html$text('MÉDIA VALORES'))
								]))
						])),
					A2(
					_elm_lang$html$Html$div,
	...
	var _user$project$View_Faturamento$bgDiv = F2(
		function (col, bg) {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								col,
								A2(_elm_lang$core$Basics_ops['++'], ' row--', bg))))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]));
		});
	var _user$project$View_Faturamento$cellFaturamentoInt = F2(
		function (f, n) {
			return A2(
	...
	var _user$project$View_Faturamento$faturamentoItemToHtml = F2(
		function (idx, item) {
			var lt30ValueAvg = A2(
				_user$project$View_Utils$divRightPadding,
				'row row--lt30ValueAvg',
				_elm_lang$html$Html$text(item.lt30ValueAvg));
			var ge30ValueAvg = A2(
				_user$project$View_Utils$divRightPadding,
				'row row--ge30ValueAvg',
				_elm_lang$html$Html$text(item.ge30ValueAvg));
			var lt30Avg = A2(_user$project$View_Faturamento$cellFaturamentoInt, 'row row--lt30DaysAvg', item.lt30Avg);
			var ge30Avg = A2(_user$project$View_Faturamento$cellFaturamentoInt, 'row row--ge30DaysAvg', item.ge30Avg);
			var lt30 = A2(_user$project$View_Faturamento$cellFaturamentoInt, 'row row--lt30Qtd', item.lt30);
			var ge30 = A2(_user$project$View_Faturamento$cellFaturamentoInt, 'row row--ge30Qtd', item.ge30);
			var daysAvg = A2(_user$project$View_Faturamento$cellFaturamentoInt, 'row row--avgPendentes', item.daysAvg);
			var pendentes = A2(_user$project$View_Faturamento$cellFaturamentoInt, 'row row--qtdPendentes', item.pendentes);
			var convenio = A2(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						convenio,
						A2(_user$project$View_Faturamento$bgDiv, 'ge30Qtd', 'redBg'),
						ge30,
						A2(_user$project$View_Faturamento$bgDiv, 'ge30DaysAvg', 'redBg'),
						ge30Avg,
						A2(_user$project$View_Faturamento$bgDiv, 'ge30ValueAvg', 'redBg'),
						ge30ValueAvg,
						A2(_user$project$View_Faturamento$bgDiv, 'lt30Qtd', 'greenBg'),
						lt30,
						A2(_user$project$View_Faturamento$bgDiv, 'lt30DaysAvg', 'greenBg'),
						lt30Avg,
						A2(_user$project$View_Faturamento$bgDiv, 'lt30ValueAvg', 'greenBg'),
						lt30ValueAvg,
						A2(_user$project$View_Faturamento$bgDiv, 'qtdPendentes', 'pinkBg'),
						pendentes,
						A2(_user$project$View_Faturamento$bgDiv, 'avgPendentes', 'pinkBg'),
						daysAvg
					]));
		});
	var _user$project$View_Faturamento$faturamentoGrupoToHtml = F2(
		function (faturamentoGrupo, rCount) {
			var rText = (_elm_lang$core$Native_Utils.cmp(rCount, 0) < 0) ? 'Carregando...' : A2(
				_elm_lang$core$Basics_ops['++'],
				'Próxima atualização em ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(rCount),
					's.'));
			var items = A2(_elm_lang$core$List$drop, faturamentoGrupo.page * 10, faturamentoGrupo.items);
			var rows = A2(
				_elm_lang$core$List$indexedMap,
				_user$project$View_Faturamento$faturamentoItemToHtml,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(faturamentoGrupo.title),
										A2(
										_elm_lang$html$Html$div,
										_elm_lang$core$Native_List.fromArray(
											[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(rText)
											]))
									])),
								A2(
								_elm_lang$html$Html$div,
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										_user$project$View_Utils$divLeftPadding,
										'header__column header__column--convenio',
										_elm_lang$html$Html$text('CONVÊNIO')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--ge30 header__column--ge30Title',
										_elm_lang$html$Html$text('CONTAS ABERTAS >= 30 DIAS')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--t25 header__column--ge30 header__column--ge30Qtd',
										_elm_lang$html$Html$text('QTD')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--t25 header__column--ge30 header__column--ge30DaysAvg',
										_elm_lang$html$Html$text('MÉD. DIAS')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--t25 header__column--ge30 header__column--ge30ValueAvg',
										_elm_lang$html$Html$text('TOTAL VALOR')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--lt30 header__column--lt30Title',
										_elm_lang$html$Html$text('CONTAS ABERTAS < 30 DIAS')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--t25 header__column--lt30 header__column--lt30Qtd',
										_elm_lang$html$Html$text('QTD')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--t25 header__column--lt30 header__column--lt30DaysAvg',
										_elm_lang$html$Html$text('MÉD. DIAS')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--t25 header__column--lt30 header__column--lt30ValueAvg',
										_elm_lang$html$Html$text('TOTAL VALOR')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--pendentes header__column--pendentesTitle',
										_elm_lang$html$Html$text('GUIAS PENDENTES')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--t25 header__column--pendentes header__column--qtdPendentes',
										_elm_lang$html$Html$text('QTD')),
										A2(
										_user$project$View_Utils$divRightPadding,
										'header__column header__column--t25 header__column--pendentes header__column--avgPendentes',
										_elm_lang$html$Html$text('MÉD. DIAS'))
									]))
							])),
						A2(
	...
	var _user$project$View_Faturamento$faturamentoHtml = F2(
		function (obj, rCount) {
			var _p0 = A2(
				_elm_lang$core$Array$get,
				obj.index,
				_elm_lang$core$Array$fromList(obj.items));
			if (_p0.ctor === 'Just') {
				return A2(_user$project$View_Faturamento$faturamentoGrupoToHtml, _p0._0, rCount);
			} else {
				return A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
	...
	var _user$project$Main$resizeCmd = F3(
		function (model, newSize, cmd) {
			var scale = _elm_lang$core$Basics$toFloat(newSize.width) / 1200.0;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{scale: scale, size: newSize}),
				_1: cmd
			};
		});
	var _user$project$Main$view = function (model) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('app--wrapper'),
	...
	var _user$project$Main$pageParser = _evancz$url_parser$UrlParser$oneOf(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
				_evancz$url_parser$UrlParser$format,
				_user$project$Main$FaturamentoView,
				_evancz$url_parser$UrlParser$s('fat')),
				A2(
				_evancz$url_parser$UrlParser$format,
				_user$project$Main$PorSetorView,
				_evancz$url_parser$UrlParser$s('porSetor'))
			]));
	var _user$project$Main$hasParser = function (location) {
	...
	var _user$project$Main$FetchSuccessSemRemessa = function (a) {
		return {ctor: 'FetchSuccessSemRemessa', _0: a};
	};
	var _user$project$Main$FetchSuccessTempoMedio = function (a) {
		return {ctor: 'FetchSuccessTempoMedio', _0: a};
	};
					...
					switch (_p9.ctor) {
						case 'Home':
							return (_elm_lang$core$Native_Utils.cmp(model.tick, 2) < 0) ? {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{tick: 0, page: _user$project$Main$FaturamentoView}),
				...
				switch (_p19._0.ctor) {
					case 'Home':
						return {
							...
							_1: _user$project$Main$setScale(_user$project$Main$Home)
						};
					case 'FaturamentoView':
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{page: _user$project$Main$FaturamentoView}),
							_1: _user$project$Main$setScale(_user$project$Main$FaturamentoView)
						};
					default:
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{page: _user$project$Main$PorSetorView}),
							_1: _user$project$Main$setScale(_user$project$Main$PorSetorView)
						};
				}
			}
		});
	...
	var _user$project$Main$main = {
		main: A2(
			...
			_elm_lang$navigation$Navigation$makeParser(_user$project$Main$hasParser),
