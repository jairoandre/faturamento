...
/***/ function(module, exports, __webpack_require__) {
	...
	var _user$project$View_Utils$divLeftPadding = F2(
		function (wrapperClass, elem) {
			return A3(_user$project$View_Utils$customDiv, wrapperClass, 'row--inner--padding', elem);
		});
	var _user$project$View_Utils$divRightPadding = F2(
		function (wrapperClass, elem) {
			return A3(_user$project$View_Utils$customDiv, wrapperClass, 'row--inner--padding--right', elem);
		});
	...
	var _user$project$View_Faturamento$cellFaturamentoInt = F2(
		function (f, n) {
			return A2(
				...
				A2(_elm_lang$core$Basics_ops['++'], 'cell cell--faturamento--', f),
				_elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(n)));
		});
	var _user$project$View_Faturamento$faturamentoItemToHtml = F2(
		function (idx, item) {
			...
			var convenio = A2(
				...
				'cell cell--faturamento--convenio',
				_elm_lang$html$Html$text(item.convenio));
			var topClass = A2(
				_elm_lang$core$Basics_ops['++'],
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('cell--wrapper--faturamento--situacao')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								convenio,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('cell--wrapper--faturamento--pendentes')
							]),
						_elm_lang$core$Native_List.fromArray(
							[pendentes, daysAvg]))
					]));
		});
	var _user$project$View_Faturamento$faturamentoGrupoToHtml = function (faturamentoGrupo) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('list--wrapper list--wrapper--faturamento')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('header--title header--title--faturamento')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text(
	...
	var _user$project$View_Faturamento$faturamentoHtml = function (obj) {
		var _p0 = A2(
			_elm_lang$core$Array$get,
			obj.index,
			_elm_lang$core$Array$fromList(obj.items));
		if (_p0.ctor === 'Just') {
			return _user$project$View_Faturamento$faturamentoGrupoToHtml(_p0._0);
		} else {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				case 'FaturamentoView':
					var faturamento = function () {
						...
						if (_p1.ctor === 'Nothing') {
							...
							return _user$project$View_Faturamento$faturamentoHtml(_p1._0);
						}
					}();
					return A2(
						_elm_lang$html$Html$div,
	...
	var _user$project$Main$Model = F7(
		function (a, b, c, d, e, f, g) {
			return {page: a, tempoMedio: b, semRemessa: c, faturamento: d, scale: e, size: f, tick: g};
		});
