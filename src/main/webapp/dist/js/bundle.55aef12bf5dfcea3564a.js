...
/***/ function(module, exports, __webpack_require__) {
			...
			if (_p0.ctor === 'Home') {
				return _elm_lang$html$Html$text(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(3 - model.tick),
							'...')));
			} else {
				var semRemessa = function () {
					var _p1 = model.semRemessa;
					if (_p1.ctor === 'Nothing') {
						return _elm_lang$html$Html$text('Carregando...');
					} else {
						return _user$project$View_SemRemessa$semRemessaToHtml(_p1._0);
					}
				}();
				var tempoMedio = function () {
					var _p2 = model.tempoMedio;
					if (_p2.ctor === 'Nothing') {
						return _elm_lang$html$Html$text('Carregando...');
					} else {
	...
	var _user$project$Main$Model = F6(
		function (a, b, c, d, e, f) {
			return {page: a, tempoMedio: b, semRemessa: c, scale: d, size: e, tick: f};
		});
	var _user$project$Main$Faturamento = {ctor: 'Faturamento'};
	...
	var _user$project$Main$pageParser = _evancz$url_parser$UrlParser$oneOf(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
				_evancz$url_parser$UrlParser$format,
				_user$project$Main$Faturamento,
				...
				case 'TickTime':
					...
					if (_p7.ctor === 'Home') {
						return (_elm_lang$core$Native_Utils.cmp(model.tick, 2) < 0) ? {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{tick: 0, page: _user$project$Main$Faturamento}),
				...
				default:
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								semRemessa: _elm_lang$core$Maybe$Just(_p4._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			}
			...
			if (_p11.ctor === 'Err') {
				...
				if (_p11._0.ctor === 'Home') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{page: _user$project$Main$Faturamento}),
						_1: _user$project$Main$setScale(_user$project$Main$Faturamento)
					};
				}
			}
		});
